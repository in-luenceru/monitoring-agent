...
' Copyright (C) 2015, monitoring agent Inc. <support@monitoring agent.com>
'
...
Public Function CreateDumpRegistryKey()
    ...
    strKeyPath = "SOFTWARE\Microsoft\Windows\Windows Error Reporting\LocalDumps\monitoring agent-agent.exe"
